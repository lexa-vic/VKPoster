...
import com.kostikov.vkposter.stickers.multitouch.MoveGestureDetector;
import com.kostikov.vkposter.stickers.multitouch.RotateGestureDetector;
...
public class MotionView extends FrameLayout {
    ...
    public interface MotionViewCallback {
        ...
        void onEntityTouch(@Nullable MotionEntity entity, @NonNull MotionEvent event);
    }
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            if (selectedEntity != null) {
                ...
                selectedEntity.getLayer().postScale(scaleFactorDiff - 1F);
                updateUI();
            }
            return true;
        }
